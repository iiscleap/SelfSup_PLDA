...
def read_arguments():
    parser = argparse.ArgumentParser(description="Deep_SSC")
    ...
    parser.add_argument("--alpha", type=float, default=0.4, help="value of alpha parameter")
    ...
    parser.add_argument("--band", type=str, default='wide',required=True, help='narrow/wide')
    parser.add_argument("--rttm_ground_path", type=str, default='None', help='path of ground truth rttm')
    parser.add_argument("--kaldi_recipe_path", type=str, default='None', help='path of ground truth rttm')
